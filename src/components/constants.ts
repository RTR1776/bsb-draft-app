...
// CSS grid template
// #(28) POS(40) NAME(wider/flexible) TM(36) ADP(36) FPTS(42) TWV(46) CONS(32) VORP(42) | 14x(minmax 36px/1fr) | TAG(40px)
export const GRID_COLS = '[rank]32px [pos]48px [name]minmax(220px,2.4fr) [team]48px [adp]40px [fpts]48px [twv]48px [cons]44px [vorp]48px repeat(14, minmax(44px, 1fr)) [tag]48px'
